...
local outline_color_cache = {0, 0, 0, 1}
    ...
    elseif mode == "editor_name_input" then
        ...
        love.graphics.pop()
                                                                                                                                                                    ...
                                                                                                                                                                    love.graphics.setFont(font) -- Сбрасываем шрифт, чтобы ширина считалась корректно
                                                                                                                                                                                                                                    love.graphics.setColor(0, 1, 0, 1)
                                                                                                                                                                                                                                    local fps_text = "FPS: " .. love.timer.getFPS()
                                                                                                                                                                                                                                    love.graphics.print(fps_text, love.graphics.getWidth() - font:getWidth(fps_text) - 10, 10)
                                                                                                                                                                                                                                    love.graphics.setColor(1, 1, 1, 1)
                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                console.draw()
